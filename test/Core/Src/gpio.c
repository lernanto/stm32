...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = W25Q16_CS_Pin|HCSR04_TRIG_Pin;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = SW18015P_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SW18015P_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = IR_FRONT_Pin|IR_BACK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
